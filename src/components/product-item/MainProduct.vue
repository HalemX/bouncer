<template>
  <div
    class="main-product overflow-hidden px-3 py-4"
  ...
  >
    ...
    >
      <div class="info-product text-white w-50">
        ...
        <base-button centerSmallScreen="center" gray-hover="hover">{{
          textButton
        }}</base-button>
      </div>
...
export default {
  ...
  setup(props) {
    const dynamicImagePath = require(`@/assets/images/${props.imageSrc}`);
    return {
      dynamicImagePath,
    };
  },
